...
export default function results() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.questionText}>You got {(scoreInt * lengthInt)}/{lengthInt} correct</Text>
      <CustomButton text='Exit Assessment' onPress={() => router.push("/(tabs)/assessment")} buttonColor={'white'}></CustomButton>
    </View>
  );
};
